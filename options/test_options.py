...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--conf_thresh', default=0.4, type=float, help='the minimum objectness confidence threshold for a context node to be associated with a sounding object')
		self.parser.add_argument('--nos_cntxt', default=20, type=int, help='the maximum number of context nodes to be associated with a sounding object')
		self.parser.add_argument('--iou_thresh', default=0.1, type=float, help='the minimum iou required for a person node to be associated with an instrument')
		...
		self.parser.add_argument('--sigma', default=25, type=float, help='the width of the smoothing kernel, expressed')
