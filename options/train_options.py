...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--num_object_per_video', default=1, type=int, help='max number of objects detected in a video clip')		
		...
		self.parser.add_argument('--subtract_mean', default=False, type=bool, help='subtract channelwise mean from input image')
		...
		self.parser.add_argument('--weights_rnn_classif', type=str, default='', help="weights of the  classifier sitting on the rnn output")
		self.parser.add_argument('--weights_fuse_enc', type=str, default='', help="weights for encoding the separated spectrogram")
		self.parser.add_argument('--weights_net_fuse', type=str, default='', help="weights for fusing the spectrogram and graph encodings")
		...
		self.parser.add_argument('--number_of_dir_classes', default=28, type=int, help='number of direction classes')
		self.parser.add_argument('--classifier_loss_weight', default=1, type=float, help='weight for classifier loss')
		self.parser.add_argument('--dir_classifier_loss_weight', default=0.05, type=float, help='weight for the direction classifier loss')
		self.parser.add_argument('--graph_loss_weight', default=0.5, type=float, help='weight for classifier loss')
		self.parser.add_argument('--use_graph_enc', type=bool, default=False, help='whether to use the graph encoding or not')
		self.parser.add_argument('--use_mult_wind', type=bool, default=False, help='whether to use multiple wndows for training or not')
		self.parser.add_argument('--nos_tr_wind', type=int, default=5, help='if using multiple wndows for training, how many to use')
		...
		self.parser.add_argument('--sigma', default=50, type=float, help='the width of the smoothing kernel, expressed')
		...
		self.parser.add_argument('--only_separation', type=bool, default=False, help="whether to only perform separation or both separation and direction prediction")
		...
		self.parser.add_argument('--lr_rnn', type=float, default=0.0001, help='learning rate for RNN')
		self.parser.add_argument('--lr_fuse', type=float, default=0.0001, help='learning rate for fusion network(s)')
