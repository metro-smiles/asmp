...
from .networks import Resnet18, AudioVisual5layerUNet, AudioVisual7layerUNet, GraphNet_0, GraphNet_1, GraphNet_2, GraphNet_3, weights_init
...
class ModelBuilder():
    ...
    def build_graph_encoder(self, feat_dim=2048, hidden_act='relu', fin_graph_rep=256, pooling_ratio=0.5, nos_classes=16, gnet_type=3, heads=4, weights=''):
        self.args = edict({
            'nhid': fin_graph_rep,
            'pooling_ratio': 0.5,
